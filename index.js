...
/////////////////
const BotName = 'Bentol'; 
const instagram = 'https://instagram.com/kanqkung'; 
const whatsapp = 'wa.me/6281283883549'; 
const kapanbotaktif = 'RANDOM'; 
const grupch1 = 'https://chat.whatsapp.com/FZmp5WLHurWLkme4zRK3Gk'; 
const grupch2 = 'Cooming Soon' ; 
const
{
   WAConnection,
   MessageType,
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig : @febby28_')
...
axios.get(`https://alfians-api.herokuapp.com/api/wiki?q=${teks}&lang=id&apiKey=zFuV88pxcIiCWuYlwg57`).then((res) => {
	conn.sendMessage(id, '[ WAIT ] Sedang di proses⏳ silahkan tunggu sebentar', MessageType.text)
